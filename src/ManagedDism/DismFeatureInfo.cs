...
namespace ManagedDism
{
    ...
    public sealed class DismFeatureInfo
    {
        ...
        public string Description
        {
            get
            {
                return _featureInfo.Description;
            }
        }
        ...
        public string DisplayName
        {
            get
            {
                return _featureInfo.DisplayName;
            }
        }
        ...
        public string FeatureName
        {
            get
            {
                return _featureInfo.FeatureName;
            }
        }
        ...
        public DismPackageFeatureState FeatureState
        {
            get
            {
                return _featureInfo.FeatureState;
            }
        }
        ...
        public DismRestartType RestartRequired
        {
            get
            {
                return _featureInfo.RestartRequired;
            }
        }
