...
namespace ManagedDism
{
    ...
    public sealed class DismImageInfo
    {
        ...
        public DismProcessorArchitecture Architecture
        {
            get
            {
                return _imageInfo.Architecture;
            }
        }
        ...
        public CultureInfo DefaultLanguage
        {
            get
            {
                return _languages.Count == 0 ? null : _languages[DefaultLanguageIndex];
            }
        }
        ...
        public int DefaultLanguageIndex
        {
            get
            {
                return (int)_imageInfo.DefaultLanguageIndex;
            }
        }
        ...
        public string ImageDescription
        {
            get
            {
                return _imageInfo.ImageDescription;
            }
        }
        ...
        public int ImageIndex
        {
            get
            {
                return (int)_imageInfo.ImageIndex;
            }
        }
        ...
        public string InstallationType
        {
            get
            {
                return _imageInfo.InstallationType;
            }
        }
        ...
        public string ProductSuite
        {
            get
            {
                return _imageInfo.ProductSuite;
            }
        }
