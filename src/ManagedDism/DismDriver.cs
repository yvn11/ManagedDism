...
namespace ManagedDism
{
    ...
    public sealed class DismDriver
    {
        ...
        public DismProcessorArchitecture Architecture
        {
            get
            {
                return (DismProcessorArchitecture)_driver.Architecture;
            }
        }
        ...
        public string HardwareDescription
        {
            get
            {
                return _driver.HardwareDescription;
            }
        }
        ...
        public string ManufacturerName
        {
            get
            {
                return _driver.ManufacturerName;
            }
        }
